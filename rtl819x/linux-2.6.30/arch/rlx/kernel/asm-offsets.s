 ...
 # -I/opt/workspace/rtl8198/rtl819x/linux-2.6.30/arch/rlx/include
 # -Iinclude/asm-rlx -Iarch/rlx/bsp/
 # -I/opt/workspace/rtl8198/rtl819x/linux-2.6.30/arch/rlx/include/asm/mach-generic
 ...
 # -march=5281 -mno-check-zero-division -mabi=32 -mno-abicalls -msoft-float
 ...
 # -msoft-float -meb -mno-check-zero-division -mexplicit-relocs -march=5281
...
->THREAD_REG16 508 offsetof(struct task_struct, thread.reg16)	 #
	
->THREAD_REG17 512 offsetof(struct task_struct, thread.reg17)	 #
	
->THREAD_REG18 516 offsetof(struct task_struct, thread.reg18)	 #
	
->THREAD_REG19 520 offsetof(struct task_struct, thread.reg19)	 #
	
->THREAD_REG20 524 offsetof(struct task_struct, thread.reg20)	 #
	
->THREAD_REG21 528 offsetof(struct task_struct, thread.reg21)	 #
	
->THREAD_REG22 532 offsetof(struct task_struct, thread.reg22)	 #
	
->THREAD_REG23 536 offsetof(struct task_struct, thread.reg23)	 #
	
->THREAD_REG29 540 offsetof(struct task_struct, thread.reg29)	 #
	
->THREAD_REG30 544 offsetof(struct task_struct, thread.reg30)	 #
	
->THREAD_REG31 548 offsetof(struct task_struct, thread.reg31)	 #
	
->THREAD_STATUS 552 offsetof(struct task_struct, thread.cp0_status)	 #
	
->THREAD_BVADDR 556 offsetof(struct task_struct, thread.cp0_badvaddr)	 #
	
->THREAD_BUADDR 560 offsetof(struct task_struct, thread.cp0_baduaddr)	 #
	
->THREAD_ECODE 564 offsetof(struct task_struct, thread.error_code)	 #
	
->THREAD_TRAPNO 568 offsetof(struct task_struct, thread.trap_no)	 #
