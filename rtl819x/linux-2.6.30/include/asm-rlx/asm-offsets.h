...
#define TASK_STRUCT_SIZE 776 /* sizeof(struct task_struct)	 # */
...
#define THREAD_REG16 508 /* offsetof(struct task_struct, thread.reg16)	 # */
#define THREAD_REG17 512 /* offsetof(struct task_struct, thread.reg17)	 # */
#define THREAD_REG18 516 /* offsetof(struct task_struct, thread.reg18)	 # */
#define THREAD_REG19 520 /* offsetof(struct task_struct, thread.reg19)	 # */
#define THREAD_REG20 524 /* offsetof(struct task_struct, thread.reg20)	 # */
#define THREAD_REG21 528 /* offsetof(struct task_struct, thread.reg21)	 # */
#define THREAD_REG22 532 /* offsetof(struct task_struct, thread.reg22)	 # */
#define THREAD_REG23 536 /* offsetof(struct task_struct, thread.reg23)	 # */
#define THREAD_REG29 540 /* offsetof(struct task_struct, thread.reg29)	 # */
#define THREAD_REG30 544 /* offsetof(struct task_struct, thread.reg30)	 # */
#define THREAD_REG31 548 /* offsetof(struct task_struct, thread.reg31)	 # */
#define THREAD_STATUS 552 /* offsetof(struct task_struct, thread.cp0_status)	 # */
#define THREAD_BVADDR 556 /* offsetof(struct task_struct, thread.cp0_badvaddr)	 # */
#define THREAD_BUADDR 560 /* offsetof(struct task_struct, thread.cp0_baduaddr)	 # */
#define THREAD_ECODE 564 /* offsetof(struct task_struct, thread.error_code)	 # */
#define THREAD_TRAPNO 568 /* offsetof(struct task_struct, thread.trap_no)	 # */
