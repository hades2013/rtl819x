...
//modify by nctu
	...
	websFormDefine(T("formUploadFromUsb"), formUploadFromUsb);
#endif
#ifdef CONFIG_RTL_WAPI_SUPPORT
	websFormDefine(T("formWapiReKey"), formWapiReKey);
	websFormDefine(T("formUploadWapiCert"), formUploadWapiCert);
	websFormDefine(T("formUploadWapiCertAS0"), formUploadWapiCertAS0);
	websFormDefine(T("formUploadWapiCertAS1"), formUploadWapiCertAS1);
...
//	websFormDefine(T("formTriggerPort"), formTriggerPort);
	...
	websFormDefine(T("formSetSNMP"), formSetSNMP);
#endif
