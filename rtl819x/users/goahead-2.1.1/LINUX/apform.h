...
extern void formUploadFromUsb(webs_t wp, char_t * path, char_t * query);
#endif
...
extern void formUploadWapiCertAS0(webs_t wp, char_t * path, char_t * query);
extern void formUploadWapiCertAS1(webs_t wp, char_t * path, char_t * query);
