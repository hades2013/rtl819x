...
//	extern	char redirect_url[];
	if (sp == NULL ||
			(!strstr(formName, "formWlanRedirect") &&
				...
				!strstr(formName, "formUploadFromUsb") &&	
#endif
...
#endif				
#ifdef CONFIG_IPV6
				!strstr(formName, "formIPv6Addr") &&
				!strstr(formName, "formDhcpv6s") &&
				!strstr(formName, "formRadvd") &&
				!strstr(formName, "formDnsv6") &&
				!strstr(formName, "formTunnel6") &&
#endif				
#ifdef CONFIG_POCKET_ROUTER_SUPPORT
				!strstr(formName, "formPocketWizard") &&
#endif
#if defined(HTTP_FILE_SERVER_SUPPORTED)
				!strstr(formName, "formusbdisk_uploadfile") &&
				!strstr(formName, "formusbdisk_connect_data") &&
#endif
