...
#define WEBS_BUFSIZE			1200		/* websWrite max output string */
#if !defined(USB_IP_HOST_SUPPORTED)
#define WEBS_SOCKET_BUFSIZ		8192			/* Bytes read from socket */
#else
//#define WEBS_SOCKET_BUFSIZ		3072			/* Bytes read from socket */  
#define WEBS_SOCKET_BUFSIZ		0x10000			/* Bytes read from socket */  
//#define WEBS_SOCKET_BUFSIZ		(65535*2)
#endif
#else
...
typedef struct websRec {
	...
	char_t			*destpath;				/* dsetpath for file upload*/
	FILE *destfile;
...
extern void  	 websTimeoutMsg(webs_t wp, int code, char_t *msg, ...);
#endif
...
#if defined(HTTP_FILE_SERVER_SUPPORTED)
extern int		 websUrlPathHandlerRequest(webs_t wp);
#endif
