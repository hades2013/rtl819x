...
websMimeType websMimeList[] = {
	...
	{ T("text/css"), T(".css") },
	{ T("text/plain"), T(".txt") },
	{ T("application/x-bzip2"), T(".bz2") },
	{ T("application/x-sh"), T(".sh") },
	{ T("application/x-sh"), T(".h") },
	{ T("application/x-sh"), T(".c") },
	{ T("application/rar"), T(".rar") },
	{ T("application/msword"), T(".doc") },
	{ T("application/vnd.ms-excel"), T(".xls") },
	{ T("application/vnd.ms-powerpoint"), T(".ppt") },
	
	{ T("application/x-javascript"), T(".js") },

#if defined(MORE_MIME_TYPES) || defined( HTTP_FILE_SERVER_SUPPORTED)
