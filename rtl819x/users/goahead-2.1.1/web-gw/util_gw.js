...
function saveChanges_wan(form)
{
  ...
  if ( wanType == 0 ){ //static IP
   ...
   /*-- keith: add l2tp support. 20080515  */
	  ...
	  if ( !checkSubnet(form.l2tpIpAddr.value,form.l2tpSubnetMask.value,form.l2tpServerIpAddr.value)) {
	      alert('Invalid server IP address!\nIt should be located in the same subnet of local IP address.');
	      form.l2tpServerIpAddr.value = form.l2tpServerIpAddr.defaultValue;
...
//alert("Band2G5GSupport="+Band2G5GSupport);	
//alert("band_value="+band_value);	
