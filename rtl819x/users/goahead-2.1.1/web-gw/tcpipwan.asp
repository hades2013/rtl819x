...
<table border=0 width="550" cellspacing=0 cellpadding=0>
  <tr><font size=2>
    ...
    method to static IP, DHCP, PPPoE, PPTP<% getInfo("usb3g_comment_start");%>, USB3G<% getInfo("usb3g_comment_end");%> or L2TP by click the item value of WAN Access
    type.
  </tr>
...
<!-- end USB3G -->
    ...
    <td width="100%" colspan="2"><font size=2>
        <b><input type="checkbox" name="ipv6_passthru_enabled" <% if (getIndex("ipv6passthrouh")) write("checked"); %> value="ON">&nbsp;&nbsp;Enable IPv6 pass through on VPN connection</b></td>
    </tr>
