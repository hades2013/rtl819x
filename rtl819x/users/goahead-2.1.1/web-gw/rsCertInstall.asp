...
<form method="post" action="/goform/formUpload8021xUserCert" enctype="multipart/form-data" name="upload8021xUserCert">
<table border="0" cellspacing="4" width="500">
 ...
 our AP must do apply changes to make 802.1x certificates active.
  ...
  <tr>
	...
	<input type="hidden" value="/rsCertInstall.asp" name="submit-url">
	<input type="hidden" value="user" name="uploadCertType">
	<input type="hidden" value="0" name="delAllCerts">
    </p>
 </form>

<form method="post" action="/goform/formUpload8021xUserCert" enctype="multipart/form-data" name="upload8021xRootCert">
<table border="0" cellspacing="4" width="500">
 <tr><font size=2>
 </tr>
  <tr><hr size=1 noshade align=top></tr>
 ...
 <form method="post" action="/goform/formUpload8021xUserCert" name="del8021xAllCerts">
<table border="0" cellspacing="4" width="500">
 <tr><font size=2>
 </tr>
  <tr><hr size=1 noshade align=top></tr>
