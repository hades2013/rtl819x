...
var band2G5GSupport=<% write(getIndex("Band2G5GSupport")); %> ;
...
var interface92d=<% write(getIndex("wlan_interface_92D"));%> ;
//### end
...
<!--
    <tr>
      <td width="30%"><font size=2><b>ACK Timeout:</b></td>
      <td width="70%"><font size=2><input type="text" name="ackTimeout" size="10" maxlength="4" value=<% getInfo("ackTimeout"); %>> (0~255 us)</td>
    </tr>
	-->
...
<!--
   ...
   <tr id="Aggregation" style="display:">
    ...
    <tr id="tx_beamforming" style="display:">
      ...
      <td width="70%"><font size=2>
      <input type="radio" name="beamforming_" value="enable"<% if (getIndex("tx_beamforming")==1) write("checked"); %>>Enabled&nbsp;&nbsp;
      <input type="radio" name="beamforming_" value="disable"<% if (getIndex("tx_beamforming")==0) write("checked"); %>>Disabled</td>
    </tr> 
    <tr>
