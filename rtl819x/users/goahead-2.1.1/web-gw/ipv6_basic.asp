...
<title>IPv6 basic setting</title>
<script>
function submit_ok()
{
	return true;
...
<form method="POST" action="/goform/formIPv6Addr" name=lanform>


<b>IPv6 Addr setting</b>

<p>
<table cellSpacing=1 cellPadding=2 border=0>
	<tr>
	<td bgColor=#aaddff>No.</td>
	<td bgColor=#aaddff>IPv6 Address</td>
	<td bgColor=#aaddff>Pre_Len</td>
	</tr>
	
	<tr>
		<td bgColor=#ddeeff>br0</td>
		<td bgColor=#ddeeff>
			...
			<input type=text name=addr_1_8 size=4 maxlength=4 enable value=<% getIPv6BasicInfo("addrIPv6_1_8"); %>>
		</td>
		<td bgColor=#ddeeff>
			/<input type=text name=prefix_len_1 size=4 maxlength=4 enable value=<% getIPv6BasicInfo("prefix_len_1"); %>>
		</td>
	</tr>
	
	<tr>
		<td bgColor=#ddeeff>eth1</td>
		<td bgColor=#ddeeff>
			...
			<input type=text name=addr_2_8 size=4 maxlength=4 enable value=<% getIPv6BasicInfo("addrIPv6_2_8"); %>>
		</td>
		<td bgColor=#ddeeff>
			/<input type=text name=prefix_len_2 size=4 maxlength=4 enable value=<% getIPv6BasicInfo("prefix_len_2"); %>>
		</td>
	</tr>	

    <tr>
    	<td colspan=3 align=center>
	    	<input type="hidden" value="/ipv6_basic.asp" name="submit-url">
	    	<input type="submit" value="Save" name="submit" onClick="return submit_ok()">
 		&nbsp;&nbsp;&nbsp;&nbsp;    	
