...
//printf("\r\n Query_Name = [%s]__[%s-%u]\r\n",Query_Name,__FILE__,__LINE__);
//printf("\r\n Domain_Name = [%s]__[%s-%u]\r\n",Domain_Name,__FILE__,__LINE__);
...
//printf("\r\n alwayshost.__[%s-%u]\r\n",__FILE__,__LINE__);	
	...
	if (domain_token != NULL)/*check if the first arg is NULL*/
	{
...
//printf("\r\n domain_token = [%s]__[%s-%u]\r\n",domain_token,__FILE__,__LINE__);		
...
//printf("\r\n token = [%s]__[%s-%u]\r\n",token,__FILE__,__LINE__);			
		...
		domain_token = strtok_r(NULL,"|", &domain_name);
